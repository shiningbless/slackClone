...
class Account extends Model {
  ...
  const Account._internal({required this.id, required name, avatarId}): _name = name, _avatarId = avatarId;
  
  factory Account({String? id, required String name, String? avatarId}) {
  ...
  String toString() {
    ...
    buffer.write("avatarId=" + "$_avatarId");
    buffer.write("}");
    
    return buffer.toString();
  }
  
  Account copyWith({String? id, String? name, String? avatarId}) {
    return Account(
      id: id ?? this.id,
      name: name ?? this.name,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'avatarId': _avatarId
  };

  static final QueryField ID = QueryField(fieldName: "account.id");
  static final QueryField NAME = QueryField(fieldName: "name");
  static final QueryField AVATARID = QueryField(fieldName: "avatarId");
